...
<form name="form2" method="post" action="">
    ...
    <h1 class="header">Make Booking</h1>
        ...
        <div class="leftColumn">
            <div class="card clearfix" style="min-height: 395px;">
                ...
                <div class="row"><label class="doubleLineLabel" for="nights">Number of Nights</label> <select name="nights" id="nights">
